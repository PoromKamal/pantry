        ...
        <div className='flex grow'>
            <div className='grow ml-5 mr-40'>
                ...
                <div className='flex m-10'>
                    <Card className='flex'>
                        <CardBody className='flex flex-row gap-4'>
                            ...
                            <Button onPress={onAddItemOpen} color="primary">Add Item</Button>
                            <Button onPress={onScanItemOpen} color="primary">Scan Receipt</Button>
                        </CardBody>
                    </Card>
                </div>
                <Modal
                ...
                >
                    ...
                    <Card className='m-10'>
                        <CardBody>
                            <div className='max-h-[500px] overflow-y-auto m-5' id='style-4'>
                                <Table removeWrapper  aria-label="Pantry Items Table">
                                    <TableHeader>
                                    <TableColumn>NAME</TableColumn>
                                    <TableColumn>QUANTITY</TableColumn>
                                    <TableColumn>PRICE</TableColumn>
